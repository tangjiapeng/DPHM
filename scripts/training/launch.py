...
from nphm_tum.models.training import TrainerAutoDecoder
...
def main(cfg_file : str,
    ...
    if color_only:
        assert color_branch
    if n_hyper > 0:
        CFG['decoder']['ex']['nhyper'] = n_hyper
        CFG['training']['lambdas']['hyper'] = lambda_hyper
