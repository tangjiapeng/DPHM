...
from nphm_tum.data.manager import DataManager
from nphm_tum import env_paths


REMOVE_LARGE_FACS = False
...
VISUALIZE = True # Set this to True for debugging, or to understand better how the training supervision looks like
